...
//                                    &af_off);
    ...
    void NDKCamera::CreatePreviewSession(ANativeWindow *previewWindow, int32_t rotation) {
        CreateSession(previewWindow, nullptr, true, rotation);
    }
