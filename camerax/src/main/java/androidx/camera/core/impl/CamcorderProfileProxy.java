...
public abstract class CamcorderProfileProxy {
     ...
     * {@link MediaRecorder.VideoEncoder#DEFAULT}, as this type is under-defined
     ...
     *
     * @return A mime-type string or {@code null} if the codec type is
     * {@link MediaRecorder.AudioEncoder#DEFAULT}, as this type is under-defined
     * and cannot be resolved to a specific mime type without more information.
     */
    @Nullable
     ...
     * {@link MediaRecorder.AudioEncoder#AAC},
     * {@link MediaRecorder.AudioEncoder#AAC_ELD},
     * and {@link MediaRecorder.AudioEncoder#HE_AAC}.
