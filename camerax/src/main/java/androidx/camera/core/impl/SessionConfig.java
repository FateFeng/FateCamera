...
public final class SessionConfig {
     ...
     *
     * <p>In practice, the {@link BaseBuilder} will be used to construct a
     * SessionConfig.
     *
    ...
    static class BaseBuilder {
        ...
        final List<StateCallback> mDeviceStateCallbacks = new ArrayList<>();
    ...
    public static class Builder extends BaseBuilder {
        ...
        public void addDeviceStateCallback(
                @NonNull StateCallback deviceStateCallback) {
